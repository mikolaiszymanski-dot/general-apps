...
> This file extends [typescript/testing.md](../typescript/testing.md) and [testing.md](../testing.md) with React specific content.
...
For those, use Playwright Component Testing or end-to-end Playwright/Cypress runs. See the `e2e-testing` skill.
