...
> This file extends [security.md](../security.md) with React Native / Expo specific content.
> The checklist and response steps from [security.md](../security.md) still apply.
